      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        <div className="flex justify-between md:items-end items-start mb-10 md:flex-row flex-col">
          <div>
            ...
            <h2 className="text-2xl lg:text-52 font-medium dark:text-white">
              Информация о недвижимости
            </h2>
            <p className="text-dark/50 dark:text-white/50 text-xm">
              Оставайтесь впереди всех на рынке недвижимости благодаря
              экспертным советам и обновлениям
            </p>
          </div>
          <Link
            href="/blogs"
            className="mt-5 bg-dark dark:bg-white text-white dark:text-dark py-4 px-8 rounded-full hover:bg-primary duration-300"
